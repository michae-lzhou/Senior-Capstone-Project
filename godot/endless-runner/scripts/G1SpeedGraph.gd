...
var base_data_points = [
	Vector2(1, 1025), Vector2(2, 1070),
	Vector2(3, 1150), Vector2(4, 1235),
	Vector2(5, 1120), Vector2(6, 1350),
	Vector2(7, 1265), Vector2(8, 1400),
	Vector2(9, 1180), Vector2(10, 1445),
	Vector2(11, 1300), Vector2(12, 1500),
	Vector2(13, 1385), Vector2(14, 1340),
	Vector2(15, 1490)
]
