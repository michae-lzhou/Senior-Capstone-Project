...
var base_data_points = [
	Vector2(1, 980), Vector2(2, 1065),
	Vector2(3, 1125), Vector2(4, 1180),
	Vector2(5, 1095), Vector2(6, 1360),
	Vector2(7, 1240), Vector2(8, 1425),
	Vector2(9, 1210), Vector2(10, 1470),
	Vector2(11, 1325), Vector2(12, 1485),
	Vector2(13, 1370), Vector2(14, 1310),
	Vector2(15, 1460)
]
